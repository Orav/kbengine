...
/// Output of current script error messages	
...
// Scripting object (usually the Python default distribution method of the object object)
#define SCRIPT_OBJECT_HREADER(CLASS, SUPERCLASS)											\
	SCRIPT_HREADER_BASE(CLASS, SUPERCLASS);													\
	/** Free Python objects are objects that are created from Python
	*/																						\
...
// Basic Scripting object (this module is usually available to inherit a base class in the Python script)
...
// Instance scripts (script object is generated by new in c++)
#define INSTANCE_SCRIPT_HREADER(CLASS, SUPERCLASS)											\
	SCRIPT_HREADER_BASE(CLASS, SUPERCLASS);													\
	/** C++new object created for a delete operation
	*/																						\
	static void _tp_dealloc(PyObject* self)													\
	{																						\
...
#define SCRIPT_HREADER_BASE(CLASS, SUPERCLASS)												\
	/* Current script module categories */																\
	...
	*/																						\
	...
	{																						\
		return CLASS::tp_new(type, args, kwds);												\
																							...
																							\
	/** python Properties or methods that request access to this module
	*/																						\
	...
	{																						\
		return static_cast<CLASS*>(self)->onScriptGetAttribute(name);						\
																							...
																							\
	/** python Request set the module's properties or methods
	*/																						\
	...
	{																						\
		return (value != NULL) ?															\
				...
				static_cast<CLASS*>(self)->onScriptDelAttribute(name);						\
																							...
																							\
	/** python Request initialization of the module object
	*/																						\
	...
	{																						\
		return static_cast<CLASS*>(self)->onScriptInit(self, args, kwds);					\
																							...
																							\
public:																						\
	/* Ultimate will be installed to store methods and members in the script module list*/										\
	...
	/* This module methods and members to be exposed to scripts will eventually be imported into 2 pointers of list above */				\
	...
	*/																						\
	...
	{																						\
		...
		return 0;																			\
																							...
																							\
	/** This interface can access the current module Scripting category 
	*/																						\
	...
	{																						\
		...
		return 0;																			\
																							...
																							\
	/** Inherit all the exposed methods of a module number 
	*/																						\
	...
	{																						\
		...
		return SUPERCLASS::calcTotalMethodCount() + nlen;									\
																							...
																							\
	/** All inherited module exposes a member number 
	*/																						\
	...
	{																						\
		...
		return SUPERCLASS::calcTotalMemberCount() + nlen;									\
																							...
																							\
	/** All number of exposed GetSet inherits module 
	*/																						\
	...
	{																						\
		...
		return SUPERCLASS::calcTotalGetSetCount() + nlen;									\
																							...
																							\
	/** All exposed members and methods of the parent class, as well as the current module installed in the final script to import the list 
	*/																						\
	...
	{																						\
		...
		SUPERCLASS::setupScriptMethodAndAttribute(lppmf, lppmd, lppgs);						\
																							...
																							\
	/** Install current script module 
		@param mod: To import from the main module
	*/																						\
...
/** This macro Initializes a script module, some necessary information filled into a Python type object
*/
...
// BASE_SCRIPT_HREADER Script to initialize the base class, this class inherited by the script
...
public:	
	...
	*/
	...
	/** 
		Script requested creation of an object 
	*/
	...
	*/
	...
	/** 
		Script request sets a property or method 
	*/
	int onScriptSetAttribute(PyObject* attr, PyObject* value);			

	/** 
		Script request to delete an attribute 
	*/
